...
class UpdateProfileViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    func createMen() {
        let imageUrls = ["http://www.wilsoninfo.com/valentines/vector-boy-with-valentine.jpg","http://worldartsme.com/images/boy-walking-with-dad-clipart-1.jpg","https://comps.canstockphoto.com/toddler-boy-wearing-a-sailor-costume-eps-vectors_csp15372437.jpg","https://vignette.wikia.nocookie.net/growingupcreepie/images/9/9e/633x475.jpg/revision/latest?cb=20140529185326"]
